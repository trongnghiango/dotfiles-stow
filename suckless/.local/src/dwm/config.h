...
static const Rule rules[] = {
	...
	RULE(.instance = "webcam-pip", .tags = ~SPTAGMASK, .isfloating = 1, .isbottomright = 1)
	RULE(.class = "webcam-pip", .tags = ~SPTAGMASK, .isfloating = 1, .isbottomright = 1)
	RULE(.title = "webcam-pip", .tags = ~SPTAGMASK, .isfloating = 1, .isbottomright = 1)
	RULE(.instance = "rec-countdown", .tags = ~SPTAGMASK, .isfloating = 1)
	RULE(.class = "rec-countdown", .tags = ~SPTAGMASK, .isfloating = 1)
...
static const BarRule barrules[] = {
	...
	{ statusmon, 0,     BAR_ALIGN_RIGHT,  width_status2d,           draw_status2d,          click_statuscmd,         hover_statuscmd,         "status2d" },
	{  0,        0,     BAR_ALIGN_RIGHT,  width_systray,            draw_systray,           click_systray,           hover_systray,           "systray" },
	{ statusmon, 0,     BAR_ALIGN_CENTER, width_status2d_center,    draw_status2d_center,   click_statuscmd_center,  hover_statuscmd_center,  "status2d_center" },
...
static const Key keys[] = {
	...
	{ 0, XF86XK_AudioRaiseVolume,                  volume_change,          {.i = +3} },
	{ 0, XF86XK_AudioLowerVolume,                  volume_change,          {.i = -3} },
