...
-- Bật / Tắt hiệu ứng Animation (Smooth ⟷ 0ms DWM Instant)
o.bind("SUPER + SHIFT + A", "Toggle animations (Smooth/0ms)", "omarchy-hyprland-animations-toggle")
o.bind("SUPER + ALT + A", "Toggle animations (Smooth/0ms)", "omarchy-hyprland-animations-toggle")
