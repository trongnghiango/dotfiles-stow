...
## 1.5. 7 Nguyên Tắc Thép Cho Bộ Khung Gầm Đa Distro & Kỷ Luật Sửa Lỗi

> **QUY ĐỊNH BẮT BUỘC CHO MỌI AI AGENT:** 
> Tuyệt đối không code theo kiểu "thấy lỗi là vá víu tạm bợ" (monkey-patching) làm phát sinh rác code, ô nhiễm môi trường và suy giảm hiệu năng. Phải tuân thủ 7 nguyên tắc thép:
...
### Kỷ Luật Sửa Lỗi (Bug-Fixing Discipline):
- **Phân tích nguyên nhân gốc rễ (RCA)**: Dùng `coredumpctl`, `gdb`, log X11 để xác định con trỏ lỗi hoặc race condition cụ thể. Tuyệt đối không đoán mò.
